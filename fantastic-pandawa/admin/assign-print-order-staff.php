<?php
// File: assign-print-order-staff.php
session_start();
...
function logDebug($message, $data = null) {
    $debug_file = '../logs/staff-assign-' . date('Y-m-d') . '.log';
...
try {
    ...
    $stmt = $conn->prepare("UPDATE print_orders SET assigned_to = ?, updated_at = NOW() WHERE id = ?");
