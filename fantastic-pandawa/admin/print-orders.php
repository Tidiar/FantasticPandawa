...
if (isset($_POST['bulk_action']) && isset($_POST['selected_orders'])) {
    ...
    if ($bulk_action == 'change_status' && isset($_POST['new_status'])) {
        ...
        $result = updateOrdersStatus($selected_orders, $new_status, 'print');
        if ($result) {
        ...
        header("Location: print-orders.php?" . http_build_query($_GET));
        exit;
    } elseif ($bulk_action == 'delete') {
        $result = deleteOrders($selected_orders, 'print');
        if ($result) {
...
if (isset($_GET['export']) && $_GET['export'] == 'csv') {
    exportPrintOrdersCSV($status_filter, $search, $date_from, $date_to);
    exit;
}

// Dapatkan pesanan print dengan filter
$orders = getPrintOrders($status_filter, $search, $date_from, $date_to, $limit, $offset);
$total_orders = countPrintOrders($status_filter, $search, $date_from, $date_to);
$total_pages = ceil($total_orders / $limit);

// Statistik singkat
$stats = [
    'total' => countPrintOrders(),
    'pending' => countPrintOrders('pending'),
    'processing' => countPrintOrders('processing'),
    'completed' => countPrintOrders('completed'),
    'canceled' => countPrintOrders('canceled')
];

// Judul halaman
$page_title = "Pesanan Print - Panel Admin";
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <i class="fas fa-print"></i> Pesanan Print
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Pesanan Print</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="print-orders.php" class="small-box-footer">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        ...
                        <a href="print-orders.php?status=pending" class="small-box-footer">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-primary">
                        ...
                        <a href="print-orders.php?status=processing" class="small-box-footer">
                            Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        <a href="print-orders.php?status=completed" class="small-box-footer">
                            Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-list"></i> Daftar Pesanan Print
                    ...
                    <div class="card-tools">
                        ...
                        <a href="print-orders.php?export=csv<?= $status_filter ? '&status=' . $status_filter : '' ?><?= $search ? '&search=' . urlencode($search) : '' ?><?= $date_from ? '&date_from=' . $date_from : '' ?><?= $date_to ? '&date_to=' . $date_to : '' ?>" 
                ...
                <div class="card-body">
                                        ...
                                        <?php foreach ($orders as $order): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?= htmlspecialchars($order['original_filename'] ?? 'N/A') ?>
                                                    <?php if (!empty($order['file_path'])): ?>
                                                        <br><a href="../<?= $order['file_path'] ?>" target="_blank" 
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <strong>Salinan:</strong> <?= $order['copies'] ?><br>
                                                            <strong>Kertas:</strong> <?= htmlspecialchars($order['paper_size']) ?>
                                                        </div>
                                                        <div class="col-6">
                                                            <strong>Warna:</strong> <?= translatePrintColor($order['print_color']) ?><br>
                                                            <strong>Jenis:</strong> <?= htmlspecialchars($order['paper_type']) ?>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <h4 class="text-muted">Tidak ada pesanan print ditemukan</h4>
                            <p class="text-muted">
                                <?php if ($status_filter || $search || $date_from || $date_to): ?>
                                    Coba ubah filter pencarian atau <a href="print-orders.php" class="btn btn-sm btn-primary">reset filter</a>
                                <?php else: ?>
                                    Belum ada pesanan print yang masuk
                                <?php endif; ?>
                            </p>
                        </div>
                    <?php endif; ?>
...
<div class="modal fade" id="changeStatusModal" tabindex="-1" role="dialog" aria-labelledby="changeStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="changeStatusForm" method="POST" action="process/update-print-order-status.php">
        ...
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">
                    <i class="fas fa-question-circle"></i> Bantuan - Manajemen Pesanan Print
                </h5>
...
<script>
// Script untuk manajemen pesanan print
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Print Orders Management System initialized');
    ...
    console.log('✅ Print Orders Management System ready!');
});
...
function quickStatusChange(orderId, newStatus) {
    ...
    form.method = 'POST';
    form.action = 'process/update-print-order-status.php';
...
/* Custom styles untuk Print Orders */
